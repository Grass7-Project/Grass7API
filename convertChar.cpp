...
wchar_t * Grass7API::Convert::convertchar(const char *stringchar)
{
...
LPCWSTR Grass7API::Convert::convertchartoLPCWSTR(const char *stringchar)
{
	LPCWSTR ptr;
	wchar_t * wcharint = Grass7API::Convert::convertchar(stringchar);
...
std::string Grass7API::Convert::WStringToString(const std::wstring& wstr)
{
	std::string str;
	size_t size;
