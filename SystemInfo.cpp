...
{
	RegGetValueW(HKEY_LOCAL_MACHINE, L"SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion", L"RegisteredOwner", RRF_RT_ANY, NULL, (PVOID)Data, &BufferSize);
}

void Grass7API::SystemInfo::GetRegisteredOrganization(wchar_t *Data, DWORD BufferSize)
{
	RegGetValueW(HKEY_LOCAL_MACHINE, L"SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion", L"RegisteredOrganization", RRF_RT_ANY, NULL, (PVOID)Data, &BufferSize);
}